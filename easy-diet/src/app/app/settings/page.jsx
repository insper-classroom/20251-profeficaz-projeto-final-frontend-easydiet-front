...
export default function Settings() {
  ...
  useEffect(() => {
    ...
    const notificacoes = JSON.parse(
      localStorage.getItem("config_notificacoes")
    );
    if (notificacoes !== null) setNotificacoesAtivas(notificacoes);

    const lembreteRef = JSON.parse(
      localStorage.getItem("config_lembreteRefeicoes")
    );
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-center justify-between">
            ...
            <Switch
              ...
              className={`${
                lembreteRefeicoes && notificacoesAtivas
                  ? "bg-green-500"
                  : "bg-gray-300"
              } relative inline-flex h-5 w-10 items-center rounded-full`}
            >
          ...
          <div className="flex items-center justify-between">
            ...
            <Switch
              ...
              disabled={!notificacoesAtivas}
              className={`${
                lembreteAgua && notificacoesAtivas
                  ? "bg-green-500"
                  : "bg-gray-300"
              } relative inline-flex h-5 w-10 items-center rounded-full`}
            >
        ...
        <div className="space-y-4">
          ...
          >
            <div className="flex items-center">
              ...
              <div>
                <h3 className="text-sm font-medium text-left text-red-600">
      ...
      {modalAberto && modalTipo === "idioma" && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          ...
          >
            ...
            <div className="p-2">
              {["Português", "English", "Español", "Français", "Deutsch"].map(
                (idioma) => (
                  <button
                    key={idioma}
            ...
            <div className="p-2">
              ...
              >
                <div>
                  ...
                  <p className="text-xs text-gray-500">
                    Libras (lb), polegadas (in)
                  </p>
                </div>
                {unidadeMedida === "Imperial" && (
                  <CheckIcon className="w-4 h-4 text-green-500" />
                )}
              </button>
            </div>
